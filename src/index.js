  ...
  response.data.daily.forEach(function (day, index) {
    ...
    forecastHtml =
      ...
      <div class="tiempo-app-forecast-day">
        <div class="tiempo-app-forecast-date">${formatDay(day.time)}</div>

        <img src="${day.condition.icon_url}" class="tiempo-app-forecast-icon" />
        <div class="tiempo-app-forecast-temperatures">
          <div class="tiempo-app-forecast-temperature">
            <strong>${Math.round(day.temperature.maximum)}º</strong>
          </div>
          <div class="tiempo-app-forecast-temperature">${Math.round(
